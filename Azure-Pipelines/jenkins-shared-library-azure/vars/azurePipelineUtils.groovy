// vars/azurePipelineUtils.groovy - Azure pipeline utilities
...
def approveDestroy(Map config) {
    ...
    emailext (
        ...
        subject: "🚨 Approval Required for Azure Terraform Destroy - Build ${currentBuild.number}",
        body: """
        WARNING: You are about to destroy Azure infrastructure.
    ...
    timeout(time: 1, unit: 'HOURS') {
        input message: '⚠️ Confirm destruction of Azure infrastructure?', ok: 'Destroy Now'
    }
}