...
blog_posts = [
    {
        ...
        "content": "This is a demo #13 of a blog application running with blue-green deployment on Azure ACI.",
        "author": "Admin",
        "date": "2023-06-15"
    },
    {
...
<html>
    ...
    <body>
        <header>
            <h1>Tech Blogs</h1>
            <p>A demonstration of blue-green deployment on Azure ACI</p>
        </header>
        <div class="container">
            <ul class="nav-tabs">
...
@app.route('/app1/create_post', methods=['POST'])
def create_post():
...
@app.route('/app1/edit_post/<post_id>')
...
@app.route('/app1/edit_post/<post_id>', methods=['POST'])
...
@app.route('/app1/delete_post/<post_id>')
def delete_post(post_id):
    global blog_posts
    blog_posts = [p for p in blog_posts if p["id"] != post_id]
    return redirect(url_for('home'))

@app.route('/app1/add_comment/<post_id>', methods=['POST'])
