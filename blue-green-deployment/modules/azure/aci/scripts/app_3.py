...
blog_posts = [
    {
        ...
        "content": "This is a demo #14 of App 3 blog application running with blue-green deployment on Azure ACI.",
        "author": "Admin",
        "date": "2023-06-15"
    },
    {
        "id": "2",
        "title": "App 3 Benefits of Blue-Green Deployment",
        "content": "App 3: Blue-green deployment is a technique that reduces downtime and risk by running two identical production environments called Blue and Green.",
...
<html>
    ...
    <body>
        <header>
            <h1>App 3 Tech Blogs</h1>
            <p>A demonstration of App 3 blue-green deployment on Azure ACI</p>
        </header>
        <div class="container">
            <ul class="nav-tabs">
