...
blog_posts = [
    {
        ...
        "content": "This is a demo #22 of App 2 blog application running with blue-green deployment on Azure VM.",
        "author": "Admin",
        "date": "2023-06-15"
    },
    {
...
<html>
    ...
    <body>
        <header>
            ...
            <p>A demonstration of App 2 blue-green deployment on Azure VM</p>
        </header>
        <div class="container">
            <ul class="nav-tabs">
