...
module "azure_acr" {
  ...
  registry_name       = var.azure.acr_name
  resource_group_name = module.azure_vnet.resource_group_name
  location            = var.azure.location
  sku                 = var.azure.acr_sku
  admin_enabled       = var.azure.acr_admin_enabled

  skip_docker_build = var.azure.skip_docker_build
  application       = var.azure.acr_application
...
module "azure_aci" {
  ...
  ip_address_type = var.azure.aci_ip_address_type
  os_type         = var.azure.aci_os_type
  restart_policy  = var.azure.aci_restart_policy
  cpu             = var.azure.aci_cpu
  memory          = var.azure.aci_memory

  application = var.azure.aci_application

  health_check_path           = var.azure.health_check_path
  health_check_initial_delay  = var.azure.health_check_initial_delay
  health_check_period         = var.azure.health_check_period
  health_check_failure_threshold = var.azure.health_check_failure_threshold
