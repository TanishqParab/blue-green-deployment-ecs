...
# Commented out due to Public IP limit (3 per subscription)
...
module "azure_vm" {
  ...
  # Key Vault variables (unused but required)
  key_vault_name      = "dummy-keyvault"
  ssh_key_secret_name = "dummy-secret"
