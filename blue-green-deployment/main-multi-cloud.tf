...
module "azure_vm" {
  ...
  ssh_private_key = var.azure_vm.ssh_private_key
  # key_vault_name      = var.azure_vm.key_vault_name      # Uncomment when Key Vault is available
  # ssh_key_secret_name = var.azure_vm.ssh_key_secret_name # Uncomment when Key Vault is available
