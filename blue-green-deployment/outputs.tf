...
output "resource_group_name" {
  ...
  value       = try(module.azure_vm_implementation.resource_group_name, null)
}

output "app_gateway_name" {
  description = "Name of the Azure Application Gateway"
  value       = try(module.azure_vm_implementation.app_gateway_name, null)
}

output "app_gateway_public_ip" {
  description = "Public IP of the Azure Application Gateway"
  value       = try(module.azure_vm_implementation.app_gateway_public_ip, null)
}

output "blue_vm_ips" {
  description = "Public IPs of blue VMs"
  value       = try(module.azure_vm_implementation.blue_vm_ips, {})
}

output "green_vm_ips" {
  description = "Public IPs of green VMs"
  value       = try(module.azure_vm_implementation.green_vm_ips, {})
}
